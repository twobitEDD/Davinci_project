...
class Wallet {
    constructor(){
		this.MAINURL   = 'https://api.s0.t.hmny.io/';
		this.TESTURL   = 'https://api.s0.b.hmny.io/';
		this.TESTEXP   = 'https://explorer.testnet.harmony.one';
		this.MAINEXP   = 'https://explorer.harmony.one';
		this.provider  = null;
		this.wallet    = null;
		this.extension = null;
		this.chainId   = null;
	...
	async start(wallet) {
		if(wallet=='metamask'){
			if(window.ethereum && window.ethereum.isMetaMask){
				...
				if(cid==1666600000 || cid==1666700000){
					// Harmony OK
				} else {
					this.chainId = cid;
					this.wallet = null;
					web3 = null;
					console.log('Metamask not connected to Harmony network');
					alert('Metamask not connected to Harmony network');
				}
